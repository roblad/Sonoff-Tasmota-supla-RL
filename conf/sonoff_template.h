...
const mytmplt modules[TASMOTA_RL_PB] PROGMEM = {
//const mytmplt modules[MAXMODULE] PROGMEM = {
  ...
  { "Tasmota-Suppla R.L.P.B.",   // RL_PB_TASMOTA hardware (ESP8266)
     0,                // not used
     GPIO_USER,        // GPIO00 D3 Wemos Button Shield
     0,        // GPIO01 TX Serial RXD
     GPIO_USER,        // GPIO02 D4 Wemos DHT Shield
     0,        // GPIO03 RX Serial TXD and Optional sensor
     GPIO_REL1,        // GPIO04 D2 Wemos I2C SDA
     GPIO_KEY3,        // GPIO05 D1 Wemos I2C SCL / Wemos Relay Shield (0 = Off, 1 = On) / Wemos WS2812B RGB led Shield
     0, 0, 0, 0, 0, 0, // Flash connection
     GPIO_USER,        // GPIO12 D6
     GPIO_REL2,        // GPIO13 D7
     GPIO_USER,        // GPIO14 D5
