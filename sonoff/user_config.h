...
#define STA_SSID1              "xxxxxxxxxxxxx"      // [Ssid1] Wifi SSID
#define STA_PASS1              "xxxxxxxxxxxxxxx"  // [Password1] Wifi password
#define STA_SSID2              "xxxxxxxxxxxxxxx"      // [Ssid2] Optional alternate AP Wifi SSID
#define STA_PASS2              "xxxxxxxxxxxxxxxx"  // [Password2] Optional alternate AP Wifi password
...
//#define USE_MQTT_TLS                             // EXPERIMENTAL Use TLS for MQTT connection (+53k code, +20k mem) - Disable by //
  ...
  #define MQTT_PASS            "xxxxxxxxxxx"       // [MqttPassword] Optional password
#endif
...
#define MQTT_CLIENT_ID         "TASS_DVES_%06X"       // [MqttClient] Also fall back topic using Chip Id = last 6 characters of MAC address

// -- MQTT - Telemetry ----------------------------
#define TELE_PERIOD            900               // [TelePeriod] Telemetry (0 = disable, 10 - 3600 seconds)
...
#define USE_WEBSERVER                            // Enable web server and wifi manager (+62k code, +8k mem) - Disable by //
  ...
  #define FRIENDLY_NAME        "TASMOTA supla sonoff"          // [FriendlyName] Friendlyname up to 32 characters used by webpages and Alexa
...
#define NTP_SERVER1            "1.lede.pool.ntp.org"       // [NtpServer1] Select first NTP server by name or IP address (129.250.35.250)
#define NTP_SERVER2            "2.lede.pool.ntp.org"    // [NtpServer2] Select second NTP server by name or IP address (5.39.184.5)
#define NTP_SERVER3            "3.lede.pool.ntp.org"  // [NtpServer3] Select third NTP server by name or IP address (93.94.224.67)
